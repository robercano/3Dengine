...
void GLFWKeyManager::DisposeKeyManager(void) { delete _keyManager; }
GLFWKeyManager::GLFWKeyManager(void) { glfwSetKeyCallback(glfwGetCurrentContext(), keyCallback); }
GLFWKeyManager::~GLFWKeyManager(void) { glfwSetKeyCallback(glfwGetCurrentContext(), NULL); }
