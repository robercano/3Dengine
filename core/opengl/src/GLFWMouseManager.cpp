...
void GLFWMouseManager::DisposeMouseManager() { delete _mouseManager; }
GLFWMouseManager::GLFWMouseManager(void) {}
GLFWMouseManager::~GLFWMouseManager(void) { glfwSetCursorPosCallback(glfwGetCurrentContext(), NULL); }
